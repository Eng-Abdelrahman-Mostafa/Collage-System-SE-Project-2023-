        ...
        <div class="form col-lg-4 col-md-4 col-sm-9 col-10 container">
            ...
            <form class="g-3 needs-validation" novalidate>
                <div class="input-group has-validation">
                    ...
                    <input class="form-control " id="validationCustomUsername" type="email" placeholder="ادخل بريدك الالكتروني" aria-describedby="inputGroupPrepend" required>
                </div>
                <div class="input-group has-validation">
                    <i class="fa-solid fa-lock"></i>
                    <input class="form-control"  type="password" placeholder="ادخل كلمه المرور" aria-label="default input example" required>
                </div>
